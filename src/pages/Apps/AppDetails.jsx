...
const AppDetails = () => {
  ...
  return (
      ...
      <div className="md:flex items-center gap-6">
        ...
        <div className="space-y-2">
          <div>
            ...
            <p className="text-gray-500 mt-1">Developed by <span className="text-[#632EE3] font-semibold">{companyName}</span></p>
          </div>
    ...
    {/* 3 card */}
        ...
        <button className="btn bg-emerald-400 text-white hover:bg-emerald-500">Install Now ({size} MB)</button>
