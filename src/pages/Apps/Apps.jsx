  ...
  return (
    <div className="max-w-7xl mx-auto p-4">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mt-8">
        <p className="font-bold mb-3 md:mb-0">({searchedApps.length}) Apps Found</p>
        <label
      ...
      {searchedApps.length === 0 && <p className="text-center text-lg text-gray-500 mt-8">No App Found</p>}
